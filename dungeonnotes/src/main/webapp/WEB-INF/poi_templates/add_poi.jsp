...
<nav class="navbar has-background-black">
	...
	<div class="columns is-centered has-background-grey-dark" style="min-height: 100vh;">
		<div class="column is-3 mt-6">
			<h3 class="title has-text-centered has-text-danger">Add Point of Interest</h3>
			<form:form action="/poi/add" method="POST" modelAttribute="newPOI">
				...
				<a href="/world/${worldId}" class="button is-dark is-pulled-left has-text-warning">Cancel</a>
				<input class="button is-dark is-pulled-right has-text-warning" type="submit" value="Create POI"/>
			</form:form>
		</div>
	</div>
</body>
